...
from models.networks.transformer_modules import TransformerDecoder, SinusoidalPositionEncoding , MoE_TransformerDecoder
import robomimic.utils.tensor_utils as TensorUtils
from typing import Tuple, Optional, Literal

    

class bc_moe_policy(nn.Module):
    def __init__(self, repr_dim=512, act_dim=7, hidden_dim=256,
        ...
        self.transformer = MoE_TransformerDecoder(
            input_size=repr_dim,
            num_layers=8,
            num_heads=4,
            head_output_size=64,
